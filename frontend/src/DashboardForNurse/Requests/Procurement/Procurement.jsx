...
const ProcurementFormNurse = () => {
  ...
  return (
      ...
      <div className="main-procurement-requestt">
        <div className="procurement-title"><NurseSidebar/><h2 className="Procurement-Page">Procurement Request Form</h2></div>
...
export default ProcurementFormNurse;