...
const LabProcurementForm = () => {
  ...
  return (
      ...
      <div className="main-procurement-requestt-rad">
        <div className="procurement-title"><LabSidebar /><h2 className="Procurement-Page">Procurement Request Form</h2></div>
...
export default LabProcurementForm;